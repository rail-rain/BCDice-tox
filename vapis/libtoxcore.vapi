    ...
    */
    ...
    public class Tox {
        ...
        ************************************/
        ...
        public delegate void AudioFunc (Tox self, int group_number, int peer_number, int16[] pcm, uint samples, uint8 channels, uint sample_rate);

        [CCode (cheader_filename="tox/toxav.h", cname = "toxav_join_av_groupchat")]
        public int join_av_groupchat (int32 friend_number, uint8[] data, AudioFunc callback);
    }
}
